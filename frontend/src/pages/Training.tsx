        ...
        <section className="mx-auto max-w-6xl px-4 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {videos.map(video => (
                    <div
                        key={video._id}
                        className="group flex flex-col rounded-2xl border border-zinc-200 bg-white dark:border-white/10 dark:bg-white/[0.03] overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-violet-500/10 dark:hover:shadow-black/30 hover:-translate-y-1"
                    >
                        ...
                        <div className="p-6 flex flex-col flex-1">
                            <h2 className="text-xl font-bold text-zinc-900 dark:text-white mb-2 flex items-center gap-2">
                                <PlayCircle className="h-5 w-5 text-violet-500 flex-shrink-0" />
                                {video.title}
                            </h2>
                        </div>
                    </div>
